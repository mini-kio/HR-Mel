...
HR-Mel은 저역 재구성을 강화하면서 고역 디테일 손실을 최소화하려는 3밴드 멜 표현입니다. 44.1 kHz 고정 파라미터로 HR-Mel을 추출하고, STFT / Mel / Log-Mel 대비 상대 복원 오차를 계산하는 최소 코드를 포함합니다.
...
| --- | --- | --- | --- | --- |
| 저역 (<1.5 kHz) | 0.3737 ± 0.0391 | **0.2729 ± 0.0345** | +0.1008 | **~27.0%** |
